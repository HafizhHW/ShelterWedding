...
<body id="home">
  ...
  <!-- CAROUSEL -->
  <section class="jumbotron" style="background-image: url(assets\image\carousel\1.jpeg);">
    <div class="container-fluid" style="background-color: #caf0f8 ;">
      <div id="myCarousel" class="carousel" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img class="first-slide" src="assets\image\carousel\LC1.jpg" alt="First slide">
          ...
          <div class="carousel-item">
            <img class="second-slide" src="assets\image\carousel\LC2.jpg" alt="Second slide">
          ...
          <div class="carousel-item">
            <img class="third-slide" src="assets\image\carousel\LC3.jpg" alt="Third slide">
